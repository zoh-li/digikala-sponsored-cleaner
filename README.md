...
رابط افزونه به‌صورت مینیمال طراحی شده و امکان مشاهدهٔ وضعیت, روشن یا خاموش‌کردن پاک‌ساز و دسترسی مستقیم به مخزن GitHub را فراهم می‌کند.

<p align="center">
  <img
    src="assets/screenshots/popup-preview.png"
    alt="رابط کاربری DigiKala Sponsored Cleaner"
    width="360"
  >
</p>
